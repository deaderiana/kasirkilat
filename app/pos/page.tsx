...
export default function CashierPage() {
  ...
  const handleCheckoutClick = async (shouldSendWA: boolean) => {
    ...
    if (paymentMethod === 'HUTANG') { 
        if (!isPro) return alert("Fitur Kasbon hanya untuk akun PRO!"); 
        if (!selectedCustomer) { alert("⚠️ WAJIB pilih Pelanggan untuk mencatat HUTANG."); setShowCustomerModal(true); return; } 
    }
